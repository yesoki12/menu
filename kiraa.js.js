...
function ut(e) {
    ...
    return {
        c() {
            ...
            Xe = G(),
            X = M("div"),
            X.innerHTML = '<span style="color:#ffffff; font-weight:500;" class="svelte-vmojrg">Beta - 1.0</span> <span style="color:#ffffff; font-weight:500;" class="svelte-vmojrg">Kiraa.lua</span>',
            i(a, "stdDeviation", "3"),
            i(a, "result", "glow"),
...
function ln(e, t, n) {
    let s = 0
      ...
      , _ = []
      , g = "left"
      , v = "https://i.pinimg.com/736x/28/0d/74/280d743541d2a0e36dfa462f7db5bd61.jpg"
      , w = []
      , b = 1;
    const d = {
        success: {
